...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    //This function favorites a tweet by sending a POST request to the favorites/create API endpoint. 
    ...
    //This function UNfavorites a tweet by sending a POST request to the favorites/destroy API endpoint
